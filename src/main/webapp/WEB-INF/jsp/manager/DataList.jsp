...
<script>
	$(function() {
		if(${jieguo }){
			$("#invoiceData").addClass("active");
			$("#outvoiceData").removeClass("active");
		}else{
			$("#outvoiceData").addClass("active");
...
<div id="dataList" style="width: 1920px; height: 327.6px">
	<div class="row">
		<div class="col-lg-12 ">
			<input type="hidden" id="the2b" name="${YYYY }">
			<h1 class="page-header" style="float: left;" id="years">${YYYY }年发票数据</h1>
	...
	<div class="thefind">
		<button type="button" id="invoiceData" class="btn btn-primary" name="1">进项发票数据</button>
		<button type="button" id="outvoiceData" class="btn btn-primary" name="0">销项发票数据</button>
		<div class="row">

			<div class="col-md-1">
				<div class="form-group label-floating is-empty" data-column="22">
					<label class="control-label " id="address_control_label">全局搜索</label>
					<input class="form-control col22_filter global_filter" type="text"
			...
			<div class="col-md-1">
				<div class="form-group label-floating is-empty" data-column="0">
					...
					<input class="form-control col0_filter column_filter" type="text"
			...
			<div class="col-md-1">
				<div class="form-group label-floating is-empty" data-column="1">
					...
					<input class="form-control col1_filter column_filter" id="buyer"
						type="text" name="buyer"> <span class="material-input"></span>
				</div>
			</div>
			<div class="col-md-1">
				<div class="form-group label-floating is-empty" data-column="6">
					<label class="control-label " id="buyer_control_label">供销商搜索</label>
					<input class="form-control col6_filter column_filter" id="buyer"
						type="text" name="buyer"> <span class="material-input"></span>
				</div>
			</div>
			<div class="col-md-1">
				<div class="form-group label-floating is-empty" data-column="7">
					<label class="control-label " id="buyer_control_label">联系方式搜索</label>
					<input class="form-control col7_filter column_filter" id="buyer"
						type="text" name="buyer"> <span class="material-input"></span>
				</div>
			</div>
			<div class="col-md-1">
			...
			<div class="col-md-1">
				<div class="form-group label-floating is-empty" data-column="5">
					<label class="control-label " id="buyer_control_label">开票日期搜索</label>
					<input class="form-control col5_filter column_filter" id="buyer"
						type="text" name="buyer"> <span class="material-input"></span>
				</div>
			</div>
		</div>
	...
	<table
		...
		<c:if test="${jieguo==true }">
			<c:forEach items="${invoiceList }" var="i">
				<tr>
					...
					<td class="col-md-1" style="text-align: right;">${i.heji }</td>
		...
		<c:if test="${jieguo==false }">
			<c:forEach items="${outvoiceList }" var="o">
				<tr>
					<td class="col-md-1">${o.o_code }</td>
					<td class="col-md-1">${o.o_number }</td>
					
					
					<td class="col-md-1" style="text-align: right;">${o.addprice }</td>
					<td class="col-md-1" style="text-align: right;">${o.heji }</td>
					<td class="col-md-1" style="text-align: right;" id="taxes${o.o_code }${o.o_number }">${o.taxesprice }</td>
					
					<td class="col-md-1" id="opendate${o.o_code }${o.o_number }">${o.opendate }</td>
					<td class="col-md-1">${o.buyer }</td>
					<td class="col-md-1">${o.client_tel }</td>
					<td class="col-md-1">${o.address }</td>
				</tr>
			</c:forEach>
		</c:if>
		</tbody>
...
<script type="text/javascript" src="theme/js/dataList.js"></script>
