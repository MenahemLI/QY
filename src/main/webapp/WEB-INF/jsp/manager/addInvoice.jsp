...
<script src="theme/js/addInvoice.js" type="text/javascript" charset="utf-8"></script>
		...
		<div class="col-md-8">
			<div class="card">
				...
				<div class="card-content">
					<form name="addInvoice" action="manager/addInvoice.action"
						method="post" id="addInvoiceForm">
						<input type="hidden" name="username" value="${user.u_number }">

	                                   <div class="row">
	                                   <div class="col-md-3">
								<div class="form-group label-floating is-empty">
									<label class="control-label" id="i_code_label">票据代码(10位或12位)</label> 
									<input class="form-control" type="text" name="i_code" id="i_code">
							...
							<div class="col-md-3">
								...
								<div class="form-group label-floating is-empty">
									<label class="control-label" id="i_number_label">票据编号(8位)</label> <input
										class="form-control" type="text" name="i_number" id="i_number">
									<span class="material-input"></span>
								</div>
							</div>
							<div class="col-md-3">
						...
						<div class="row">
							...
							<div class="col-md-6">
								<div class="form-group label-floating is-empty">
									<label class="control-label" id="vendor_control_label">供应商</label>
									<input class="form-control" id="vendor" type="text"
										name="vendor"> <span class="material-input"></span>
								</div>
							</div>
						</div>
	                                    ...
	                                    <div class="row">
										 ...
										 <input type="button" class="btn btn-primary pull-right" value="确认提交" onclick="raemo()"  >
				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
						...
						<thead>
							...
							<tbody >
							<c:forEach items="${inList }" var="i" varStatus="s">
								<tr  id="colorList"  value="${i }">
									<td>${i.get(0).i_number }</td>
									<td>进项</td>
									<td>${i.get(0).date }</td>
								</tr>
							</c:forEach>
			...
			<div class="modal-body">
				<div class="row">
					<div class="col-md-7">
						...
						<div class="col-md-10" id="i_number_item"></div>
					</div>
					<div class="col-lg-5">
						<div class="col-md-4">供应商：</div>
						<div class="col-md-8" id="vendor_item"></div>
					</div>
				</div>
