...
<script src="theme/js/chart-month-data.js" type="text/javascript" charset="utf-8"></script>
...
<script src="theme/js/monthChart.js" type="text/javascript" charset="utf-8"></script>
<script>
	...
	$(function() {
		...
		$("#searchrFrom").on("submit",function(){
			...
			var MM =$(this).find("select[name=MM]").val();
			$("#monthC").load("manager/toMonthChart.action",{
				YYYY:YYYY,
				MM:MM
			});
			return false;
...
<div id="monthC">
    <div class="row">
			...
			<input type="hidden" value=${MM } id="thisMM">
				<h1 class="page-header" style="float: left;">月分析图</h1>
		...
		<div class="row">
			<div class="col-lg-12">
				<div class="panel panel-default">
					...
					<div id="linechart" class="panel-body" value=${dayOutPrices } name="${dayInPrices }">
		...
		<div class="row">
			<div class="col-md-6">
				<div class="panel panel-default">
					...
					<div class="panel-body" id="piechart" value="${salesInList }" name="${salesInVolumeList }">
						<div class="canvas-wrapper">
			...
			<div class="col-md-6">
				<div class="panel panel-default">
					...
					<div class="panel-body" id="doughnutchart"  value="${salesOutList }" name="${salesOutVolumeList }">
						<div class="canvas-wrapper">
